...
function noindex_woocommerce_thin_content() {
	if ( is_product_taxonomy() ) { // woocommerce product attribute archives
    	wp_no_robots();
  	}
	if ( is_tax() && function_exists( 'taxonomy_is_product_attribute' ) ) { // individual product attribute page
    	wp_no_robots();
  	}
}
endif;
